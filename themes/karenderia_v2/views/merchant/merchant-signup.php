          ...
          <template v-if="membership_commission[membership_type]">            
            <template v-if="membership_commission[membership_type][items.service_code]">              
              <template v-if="membership_commission[membership_type][items.service_code].commission_type=='percentage'">
                 <p class="m-0">{{membership_commission[membership_type][items.service_code].commission}}% fee per order</p>
              </template>
              <template v-else>
                 <p class="m-0">{{membership_commission[membership_type][items.service_code].commission}} fixed order fee</p>
              </template>
            </template>
          </template>   
       </div>
