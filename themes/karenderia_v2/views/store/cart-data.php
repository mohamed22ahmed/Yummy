    ...
    <template v-for="summary in cart_summary">
        <div class="d-flex justify-content-between align-items-center mb-1">
            ...
            <template v-else>
                ...
                <div v-if="summary.name=='Delivery Fee' && summary.value == summary.pay">{{ summary.value }}</div>
                <div v-else-if="summary.name=='Delivery Fee' && summary.value != summary.pay">{{ summary.value }} &nbsp; &nbsp; <span style="color: red">{{ summary.pay }}</span></div>
                <div v-else>{{ summary.value }}</div>
            </template>
        </div> <!--flex-->
    </template>
