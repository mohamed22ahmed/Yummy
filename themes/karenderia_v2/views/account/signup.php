...
<div class="login-container m-auto pt-5 pb-5">
  ...
  <h5 class="text-center mb-4"><?php echo t("Register")?></h5>
  ...
  <div class="forms-center">
	   ...
	   <button class="btn btn-green w-100" :class="{ loading: loading }" :disabled="ready==false" >
	      <span v-if="loading==false"><?php echo t("Sign Up")?></span>
	   ...
	   <div class="mt-3 text-center">
	     <p class="m-0"><?php echo t("Have an account")?>?</p>
	     <a  href="<?php echo Yii::app()->createUrl("/account/login",array(
	      'redirect'=>$redirect_to
	     ))?>" class="btn btn-white p-0 font14"><?php echo t("Sign in")?></a>
	   </div>
