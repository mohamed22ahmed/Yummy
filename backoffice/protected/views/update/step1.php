...
<div class="text-center p-2 pt-4">
  <h5>Karenderia Update Process</h5>
</div>
...
<div class="card-body">
  ...
  <div class="tex-center m-3">
    <a href="<?php echo Yii::app()->createUrl('/update/step2',array('version'=> date("c") ))?>" class="btn btn-success w-100 rounded-0">Update Now</a>
  </div>
