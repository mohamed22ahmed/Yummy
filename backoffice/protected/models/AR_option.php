...
class AR_option extends CActiveRecord
{
	...
	$sms_notify_number,$facebook_page,$twitter_page,$google_page,$apple_page,$merchant_enabled_alert,$merchant_email_alert,$merchant_mobile_alert,
    ...
    $free_delivery_on_second_order, $free_delivery_on_third_order,
    $first_order_free_delivery_up_to_amount, $second_order_free_delivery_up_to_amount, $third_order_free_delivery_up_to_amount,
    $first_order_free_delivery_minimum_cart_amount, $second_order_free_delivery_minimum_cart_amount, $third_order_free_delivery_minimum_cart_amount,
    $merchant_free_delivery_forced, $merchant_service_fee,$merchant_service_fee_applytax;
	...
	$merchant_google_client_id,$merchant_google_client_secret,$merchant_apple_login_enabled,
	$merchant_apple_client_id,$merchant_apple_team_id;
	...
	public $driver_enabled_alert, $driver_alert_time,$driver_prep_check_when_assign,$driver_assign_prep_time,
	...
	$points_registration,$points_review,$points_first_order,$points_booking,$points_expiry,$points_use_thresholds;
	...
	public function attributeLabels()
	{
		return array(		    
            ...
            'apple_client_id'=>t("Client ID"),
            'apple_client_secret'=>t("Client Secret"),
            'apple_client_redirect_url'=>t("Redirect URL"),
            ...
            'merchant_apple_client_id'=>t("Client ID"),
		    'merchant_apple_team_id'=>t("Team ID"),
			...
			'driver_time_allowed_accept_order'=>t("Time in seconds"),
	...
	public function rules()
	{
		return array(
		  ...
		  array('website_time_picker_interval,signup_resend_counter,review_send_after,merchant_order_critical_mins,merchant_order_reject_mins,merchant_time_picker_interval', 
		  ...
		  merchant_near_expiration_day,order_idle_admin_minutes,order_sms_code_waiting,free_delivery_above_price,driver_sendcode_interval,driver_time_allowed_accept_order,driver_assign_prep_time,
		  digitalwallet_topup_minimum,digitalwallet_topup_maximum
		  ...
		  google_client_secret,google_client_redirect_url,apple_login_enabled,apple_client_id,
		  apple_team_id,apple_client_redirect_url,enabled_contact_form,contact_email_receiver,
		  ...
		  array('image,image2', 'file', 'types'=>Helper_imageType, 'safe' => false,
            ...
            array('first_order_free_delivery_up_to_amount,second_order_free_delivery_up_to_amount,
            third_order_free_delivery_up_to_amount', 'numerical', 'integerOnly'=>true, 'min'=>0, 'max'=>100),

            array('first_order_free_delivery_minimum_cart_amount,second_order_free_delivery_minimum_cart_amount,
            third_order_free_delivery_minimum_cart_amount', 'numerical', 'integerOnly'=>true),
		  ...
		  merchant_minimum_order_pickup,merchant_maximum_order_pickup,merchant_minimum_order_dinein,merchant_maximum_order_dinein,
		  sms_notify_number,facebook_page,twitter_page,google_page,apple_page,merchant_enabled_alert,merchant_email_alert,merchant_mobile_alert,
		  order_verification,order_sms_code_waiting,merchant_pickup_estimation,free_delivery_on_first_order,free_delivery_on_second_order,
		  free_delivery_on_third_order,
		  first_order_free_delivery_up_to_amount,second_order_free_delivery_up_to_amount,third_order_free_delivery_up_to_amount,
		  first_order_free_delivery_minimum_cart_amount,second_order_free_delivery_minimum_cart_amount,third_order_free_delivery_minimum_cart_amount,
		  merchant_free_delivery_forced,merchant_service_fee,
		  ...
		  chat_enabled,chat_enabled_merchant_delete_chat,backend_phone_mask,enabled_include_utensils,signup_complete_registration_tpl',
		  'safe'),
		  ...
		  array('website_terms_customer_url,facebook_page,twitter_page,google_page,apple_page,merchant_extenal','url',
		   'defaultScheme'=>'http',
		  ...
		  merchant_google_client_secret,merchant_apple_login_enabled,merchant_apple_client_id,
		  merchant_apple_team_id,
		  ...
		  array('driver_enabled_alert,driver_alert_time,driver_enabled_auto_assign,driver_prep_check_when_assign,
		  ...
		  driver_request_break_limit,driver_enabled_delivery_otp,driver_maximum_cash_amount,driver_maximum_cash_amount,driver_time_allowed_accept_order,driver_assign_prep_time,driver_enabled_time_allowed_acceptance,
		  ...
		  points_minimum_redeemed,points_maximum_redeemed,points_registration,points_review,points_first_order,points_booking', 
			'numerical', 'integerOnly' => false,
			'min'=>0.1,		  
			'tooSmall'=>t("You must enter at least greater than 1"),			
			'message'=>t(Helper_field_numeric),
