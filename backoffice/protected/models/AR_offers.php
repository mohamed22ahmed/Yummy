...
{	
	...
	public $applicable_selected, $merchant_ids;
	/**
    ...
    {
        return array(
            'merchants' => array(self::MANY_MANY, 'AR_merchant', 'st_offers_merchant(offers_id, child_merchant_id)'),
        );
    }
	...
	public function rules()
	{
		return array(
		  ...
		  array('applicable_selected,merchant_ids','safe'),
