...
{	
	...
	public $image,$merchant_id,$new_password,$repeat_password,$old_password,$merchant_ids;
    ...
    {
        return array(
            'merchants' => array(self::MANY_MANY, 'AR_merchant', 'st_user_shared_merchant(merchant_user_id, child_merchant_id)'),
        );
    }
	...
	public function rules()
	{
		 return array(
            ...
            array('last_name,status,main_account,merchant_ids','safe'),
