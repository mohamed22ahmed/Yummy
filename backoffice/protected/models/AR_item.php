...
{	
	...
	$discount,$discount_type,$discount_start,$discount_end,$discount_valid,$sequence,$is_bulk
	;
	...
	public function rules()
	{
		return array(
		  ...
		  supplier_id,item_short_description,sku,item_featured,available,color_hex,item_short_description_translation,is_bulk,locations
		  ','safe'),
