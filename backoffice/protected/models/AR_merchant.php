...
{	
	...
	public $featured;
	public $applicable_discount_type;
	...
	public function relations()
	{
		 return array(
           ...
           'parent' => array(self::BELONGS_TO, 'AR_merchant', 'parent_id'),
           'children' => array(self::HAS_MANY, 'AR_merchant', 'parent_id'),
           'vouchers' => array(self::MANY_MANY, 'AR_voucher', 'st_voucher_merchant(merchant_id, voucher_id)'),
           'offers' => array(self::MANY_MANY, 'AR_offers', 'st_offers_merchant(child_merchant_id, offers_id)'),
           'users' => array(self::MANY_MANY, 'AR_merchant_user', 'st_user_shared_merchant(child_merchant_id, merchant_user_id)'),
	...
	{
		 return array(
            array('restaurant_slug,restaurant_name,ar_restaurant_name,contact_phone,contact_email,cuisine2,service2,
            ...
            array('restaurant_slug,restaurant_name,ar_restaurant_name,contact_phone,contact_email,contact_name,
            restaurant_phone,,description',
            ...
            type,view_type,parent_id','safe'),

            array('short_description','length','max'=>1000),
                        
            
            array('merchant_type,package_id,allowed_offline_payment,invoice_terms,invoice_terms2,commission_type,commission_value,city_id','safe'),

            array('is_featured','safe','on'=>'featured'),              
            array('disabled_ordering,close_store','safe'),
                                 
            array('address,ar_address,latitude,lontitude,city_id','required','on'=>'address'),
			...
			array('restaurant_name,ar_restaurant_name,address,ar_address,contact_email,contact_phone,merchant_type',
	...
	public function attributeLabels()
	{
		return array(
		    ...
		    'ar_restaurant_name'=>t("Restaurant name in Arabic"),
    ...
    /**
     * @return bool whether the merchant is entity or not
     */
    ...
    {
        return $this->type === 'SUPERMARKET_CHAIN' || $this->type === 'CHAIN' || $this->type === 'STORE_CHAIN';
    }
