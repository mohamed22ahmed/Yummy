...
if($parent_id){               
    ...
    $model = new AR_menu();
    $model->menu_type=$menu_type_admin;
    $model->menu_name="City Discount List";
    $model->parent_id=intval($parent_id);
    $model->link="promo/city_discounts";
    $model->action_name="promo/city_discounts";
    $model->sequence=1;
    $model->visible =1;
    $model->role_create = 'promo/city_discount_create';
    $model->role_update = 'promo/city_discount_update';
    $model->role_delete = 'promo/city_discount_delete';
    $model->role_view = '';
    $model->save();
    ...
    $model = new AR_menu();
    $model->menu_type=$menu_type_admin;
    $model->menu_name="Delivery Discount List";
    $model->parent_id=intval($parent_id);
    $model->link="promo/city_delivery_discounts";
    $model->action_name="promo/city_delivery_discounts";
    $model->sequence=1;
    $model->visible =1;
    $model->role_create = 'promo/city_delivery_discount_create';
    $model->role_update = 'promo/city_delivery_discount_update';
    $model->role_delete = 'promo/city_delivery_discount_delete';
    $model->role_view = '';
    $model->save();
}
