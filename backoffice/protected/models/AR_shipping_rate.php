...
{	
	...
	public $shipping_rate_zone_values;
	...
	{
		return array(
		  array('merchant_id,shipping_type,distance_from,distance_to,shipping_units,distance_price,estimation,shipping_rate_zone_values',
		  ...
		  array('minimum_order,maximum_order,shipping_rate_zone_values','safe'),
