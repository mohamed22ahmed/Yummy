...
{	
    ...
    public function actioncity_discount_list()
    {
        $cols=array(
            array(
                'key'=>'city_discount_id',
                'value'=>'city_discount_id'
            ),
            array(
                'key'=>'city_name',
                'value'=>'city_name',
                'action'=>"format",
                'format'=>'<h6>[city_name] <span class="badge ml-2 post [status]">[status_title]</span></h6>	 	    	 	    
	 	    <p class="dim">'.t("Expiration").'. [expiration]</p>
	 	    ',
                'format_value'=>array(
                    '[city_name]'=>'city_name',
                    '[status]'=>'status',
        ...
        $stmt = "
		 ...
		 FROM {{city_discount}} a
		 JOIN {{location_cities}} l ON a.city_id = l.city_id
		 WHERE 1=1		 
		 [and]
		 [search]
		 [order]
        ...
        DatatablesTools::$action_edit_path = "promo/city_discount_update";
    ...
    public function actioncity_delivery_discount_list()
    {
        $cols=array(
            array(
                'key'=>'city_delivery_discount_id',
                'value'=>'city_delivery_discount_id'
            ),
            array(
                'key'=>'city_name',
                'value'=>'city_name',
            ...
            array(
                ...
                'value'=>'city_delivery_discount_id',
                'action'=>"editdelete",
                'id'=>'city_delivery_discount_id'
            ),
        );

        $stmt = "
	 	 SELECT SQL_CALC_FOUND_ROWS
        a.city_delivery_discount_id, 
        a.city_id, 
        CASE a.discount_level
        WHEN 'FIRST_ORDER' THEN 'First Order Discount'
        WHEN 'SECOND_ORDER' THEN 'Second Order Discount'
        WHEN 'THIRD_ORDER' THEN 'Third Order Discount'
        ELSE 'Unknown Discount Level'
        ...
        DatatablesTools::$action_edit_path = "promo/city_delivery_discount_update";
		...
		$cols=array(
		  ...
		  array(
		    'key'=>'formatted_address',
	 	    ...
	 	    'action'=>"format",	 	  
	 	    'format'=>'<h6>[formatted_address]</h6>	 	    
	 	    ',
	 	    'format_value'=>array(
