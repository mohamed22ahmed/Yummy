...
class CommonController extends CController
{
	...
	public function init()
	{
		...
		/* add rtl 2024-23-9 mazen */
		if($is_rtl){
			$include = array('backend-core-rtl','backend-css','admin-js','admin-order-js');
		} else $include = array('backend-core','backend-css','admin-js','admin-order-js');
		/* add rtl 2024-23-9 mazen */
		
		//$include = array('backend-core','backend-css','admin-js' ,'admin-order-js');
