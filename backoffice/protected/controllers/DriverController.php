...
class DriverController extends CommonController
{
	...
	public function actionsettings()
	{
		...
		'driver_enabled_auto_assign','driver_prep_check_when_assign','driver_assign_prep_time','driver_allowed_number_task','driver_assign_when_accepted','driver_map_enabled_cluster','driver_task_take_pic','driver_enabled_request_break',
		...
		'driver_add_proof_photo','driver_on_demand_availability'
	   );
	...
	public function actionsignup_settings()
	{
		...
		$options = [
			...
			'driver_commission_type','driver_registration_process'
		];
