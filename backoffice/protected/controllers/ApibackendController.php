...
HTML;
    ...
    public function actionorderHistory()
    {
		...
		$criteria=new CDbCriteria();
		$criteria->alias = "a";
		$criteria->select = "a.order_id, a.client_id, a.status, a.order_uuid, a.prep_time, a.actual_prep_time,
        ...
        if($models){        				
        	...
        	foreach ($models as $item) {   								
        		...
        		$data[]=array(
				  ...
				  'available'=>$checkbox,
				  'item_name'=>'<h6>'.$item->item_name.'<span class="badge ml-2 post '.$item->status.'">'.$item->status.'</span></h6>
				  <p class="dim">				 	   		 	   
				  ...
				  ',
				  'category_group'=>'<p class="font-weight-bold">'.$category_group.'</p>',
				  'price'=>$size_group,		
...
$action = <<<HTML
<div class="btn-group btn-group-actions" role="group">
  <a href="$qrcode" class="btn btn-light tool_tips" data-toggle="tooltip" data-placement="top" title="" data-original-title="QrCode"  target="_blank" download >
   <i class="fa fa-qrcode"></i>
  </a>

  <a href="$tableside_settings" class="btn btn-light tool_tips" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tableside QrCode Configuration"   >
   <i class="fa fa-cog"></i>
  </a>

  <a href="$view" class="btn btn-light tool_tips" data-toggle="tooltip" data-placement="top" title="" data-original-title="View Table QrCode">
  ...
  <a href="javascript:;" data-id="$items->table_uuid" class="btn btn-light datatables_delete tool_tips" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
  <i class="zmdi zmdi-delete"></i>
  </a>
</div>
HTML;
...
HTML;
	...
	public function actiongetMenu()
	{
		try {
			...
			$cacheKey = 'cache_merchant_search_menu';
	...
	public function actiongetOpeningHoursAttribute()
	{
		try {
            ...
            if(isset($merchant_id) && !empty($merchant_id)){
                $parent_merchant_id = intval(Yii::app()->merchant->merchant_id);
                $merchant = CMerchants::getMerchantUnderParent(intval($merchant_id), $parent_merchant_id);
...
HTML;
	...
	public function actionsaveaddress()
	{
		try {
			...
			$distance_data =  MapSdk::getOrSaveCachedDistance();
