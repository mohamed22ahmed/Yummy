    ...
    public $merchant;
	 ...
	 {		 		 	  
	 	  ...
	 	  $menu[]=array(
	 	    ...
	 	    'url'=>array("/services/settings_pickup", 'id'=>$this->merchant->merchant_id)
	 	  );	 	  	 	 	 	
	 	  
	 	  $menu[]=array(
	 	    'label'=>'<i class="zmdi zmdi-comments"></i>'.t("Instructions"),
	 	    'url'=>array("/services/pickup_instructions", 'id'=>$this->merchant->merchant_id),
	 	    'itemOptions'=>array(
	 	      'class'=>"instructions"
	 	    )
	 	  );
         ...
         if(isset($this->merchant->isChain) && $this->merchant->isChain === true){
             ...
             foreach ($this->merchant->children as $child){
                 ...
                 $menu[]=array(
                     ...
                     'url'=>array("/services/settings_pickup", 'id'=>$child->merchant_id)
                 );
             }
             ...
             $menu[]=array(
                 ...
                 'url'=>array("/services/settings_pickup", 'id'=>$this->merchant->parent->merchant_id)
             );
