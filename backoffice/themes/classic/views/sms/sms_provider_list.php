<nav class="navbar navbar-light justify-content-between">
  ...
  <h5><?php echo CHtml::encode($this->pageTitle)?></h5>
    ...
    <div class="p-2">
	  ...
	  href="<?php echo isset($link_send_sms)?$link_send_sms:''?>">
	    <i class="zmdi zmdi-smartphone-android"></i>
	  </a>
	  </div>
	  <div class="p-2 mr-4"><h5><?php echo t("Send SMS")?></h5></div>
...
<th width="10%"><?php echo t("Default")?></th>
...
$this->renderPartial("/admin/modal_restore",array(
  ...
  'content'=>t("Are you sure, this will permanently delete your previous providers?"),
  'link'=>Yii::app()->CreateUrl("sms/provider_restore")
));
?>