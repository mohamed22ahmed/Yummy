                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">		
                        <?php if(is_array($status_list) && count($status_list)>=1):?>                        
                            <?php foreach ($status_list as $key => $value):?>
                                <a class="dropdown-item <?php echo $data['status']==$key?"disabled":""?>" href="<?php echo Yii::app()->CreateUrl("/reservation/update_status",[
                                   'id'=>$data['reservation_uuid'],
                                   'status'=>$key,
                                   'redirect'=>Yii::app()->createAbsoluteUrl("/reservation/reservation_overview",['id'=>$data['reservation_uuid']])
                                ])?>"><?php echo $value;?></a>
                            <?php endforeach;?>
                        <?php endif;?>
                    </div>
        ...
        <div class="row">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <div class="tab-pane fade pt-3 pl-2" id="reservation" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    :ref_id="<?php echo $data['client_id']?>"
                    :settings="{
