...
<h6 class="mb-2 mt-3"><?php echo t("Auto assign after prep checking")?></h6>
<div class="row">
    <div class="col-3 custom-control custom-switch custom-switch-md">
        <?php echo $form->checkBox($model,"driver_prep_check_when_assign",array(
            'class'=>"custom-control-input",
            'value'=>1,
            'id'=>"driver_prep_check_when_assign",
            'checked'=>$model->driver_prep_check_when_assign==1?true:false
        )); ?>
        <label class="custom-control-label" for="driver_prep_check_when_assign">
            <?php echo t("Enabled")?>
        </label>
    </div>
    <div class="col-3 form-group">
        <?php echo $form->textField($model,'driver_assign_prep_time',array(
            'class'=>"form-control form-control-text",
            'placeholder'=>$form->label($model,'driver_assign_prep_time'),
        )); ?>
    </div>
</div>
