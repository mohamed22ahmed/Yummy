...
:label="{    
    title : '<?php echo CJavaScript::quote(t("Cashout Details"))?>',
...
<?php $this->renderPartial("/driver/filter_payout",[
  'template_name'=>isset($ajax_url)?'xtemplate_order_filter':'xtemplate_payout_filter'
]);?>