...
<h5 class="card-title"><?php echo t("Status for Prepending order")?></h5>
<div class="form-label-group">
    <?php echo $form->dropDownList($model,'status_prepending_order', (array) $status_list,array(
        'class'=>"form-control custom-select form-control-select",
        'placeholder'=>$form->label($model,'status_prepending_order'),
    )); ?>
    <?php echo $form->error($model,'status_prepending_order'); ?>
</div>

<h5 class="card-title"><?php echo t("Status for With Delivery order")?></h5>
<div class="form-label-group">
    <?php echo $form->dropDownList($model,'status_with_delivery_order', (array) $delivery_status_list,array(
        'class'=>"form-control custom-select form-control-select",
        'placeholder'=>$form->label($model,'status_with_delivery_order'),
    )); ?>
    <?php echo $form->error($model,'status_with_delivery_order'); ?>
</div>
