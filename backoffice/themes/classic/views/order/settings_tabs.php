    ...
    <div class="card">
        <div class="card-body">
            <components-order-tabs
                ...
                :label="{
                   title:'<?php echo CJavaScript::quote(t("Prepending Orders"))?>',
    ...
    <div class="card">
        <div class="card-body">
            <components-order-tabs
                ref="tabs"
                ajax_url="<?php echo Yii::app()->createUrl("/api")?>"
                :status_list='<?php echo json_encode($delivery_status_list)?>'
                group_name="with_delivery"
                :label="{
                   title:'<?php echo CJavaScript::quote(t("With Delivery Orders"))?>',
                   text:'<?php echo CJavaScript::quote(t("select the status that will show on this tab."))?>',
                   save : '<?php echo CJavaScript::quote(t("Save"))?>',
                }"
            >
