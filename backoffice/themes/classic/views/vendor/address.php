...
<div class="form-label-group">
    <?php echo $form->textField($model,'ar_address',array(
        'class'=>"form-control form-control-text",
        'placeholder'=>$form->label($model,'ar_address'),
    )); ?>
    <?php
    echo $form->labelEx($model,'ar_address'); ?>
    <?php echo $form->error($model,'ar_address'); ?>
</div>
