...
{	
	...
	$room_name,$total_in_kicthen,$merchant_uuid,$item_name,$item_status,$table_status,$kicthen_merchant_uuid,$transaction_type;
	/**
	...
	public function rules()
	{
		return array(
		  ...
		  date_modified,ip_address,send_order,payment_status,total,table_uuid,transaction_type,hold_order_reference,change_trans,is_view','safe'),
